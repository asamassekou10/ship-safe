...
const LABELS: Record<string, { label: string; color: string; bg: string }> = {
  ...
  kimi:             { label: 'Kimi K3',             color: '#f97316', bg: 'rgba(249,115,22,0.10)' },
  moonshot:         { label: 'Kimi K3',             color: '#f97316', bg: 'rgba(249,115,22,0.10)' },
  'kimi-k3':        { label: 'Kimi K3',             color: '#f97316', bg: 'rgba(249,115,22,0.10)' },
  'kimi-k2.6':      { label: 'Kimi K2.6',           color: '#f97316', bg: 'rgba(249,115,22,0.10)' },
