...
const ogImage = 'https://shipsafecli.com/api/og?title=Simple%2C+transparent+pricing.&description=The+CLI+is+always+free+and+open-source.+Pro+%26+Team+plans+for+the+cloud+dashboard%2C+GitHub+integration%2C+and+team+collaboration.&label=Pricing&badge=Free+CLI+forever';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shipsafecli.com/pricing',
  },
  openGraph: {
    ...
    type: 'website',
    url: 'https://shipsafecli.com/pricing',
    siteName: 'Ship Safe',
