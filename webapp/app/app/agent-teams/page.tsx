    ...
    <div className={styles.page}>
      <div className={styles.header}>
        ...
        {isPaid ? (
          ...
          <a href="/app/checkout?plan=pro" className={styles.newBtn} style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', color: 'var(--text-muted)', textDecoration: 'none' }}>
            🔒 Upgrade to unlock
          </a>
        )}
      </div>
      ...
      {!isPaid && !loading && (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', padding: '0.85rem 1rem', background: 'color-mix(in srgb, var(--accent) 8%, transparent)', border: '1px solid color-mix(in srgb, var(--accent) 25%, transparent)', borderRadius: 10, marginBottom: '1rem', flexWrap: 'wrap' }}>
          ...
          <a href="/app/checkout?plan=pro" style={{ flexShrink: 0, fontSize: '0.82rem', fontWeight: 600, color: 'var(--accent)', textDecoration: 'none', whiteSpace: 'nowrap' }}>Upgrade → $9/month</a>
        </div>
      )}
