...
export default function NewScan({ freeScansUsed, freeScansLimit }: { freeScansUsed: number; freeScansLimit: number }) {
  ...
  const isPaidPlan = freeScansLimit === 0;
  const freeRemaining = Math.max(0, freeScansLimit - freeScansUsed);
  ...
  return (
    <div className={styles.page}>
      ...
      {!isPaidPlan && (
        <div className={freeRemaining > 0 ? styles.trialBanner : styles.trialBannerExhausted}>
          {freeRemaining > 0 ? (
            <>
