...
const ogImage = 'https://shipsafecli.com/api/og?title=Security+Guides+for+Developers&description=Vulnerability+research%2C+supply+chain+deep-dives%2C+and+practical+security+advice+from+the+Ship+Safe+team.&label=Blog';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://shipsafecli.com/blog',
  },
  openGraph: {
    ...
    type: 'website',
    url: 'https://shipsafecli.com/blog',
    siteName: 'Ship Safe',
