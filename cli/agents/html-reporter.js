...
<div class="container">
  ...
  <div style="text-align:center;margin:1.5rem 0">
    <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(`My project scored ${scoreResult.score}/100 (Grade ${scoreResult.grade.letter}) on Ship Safe! Scan yours: npx ship-safe audit . https://shipsafe.sh`)}" target="_blank" rel="noopener" style="display:inline-block;padding:8px 18px;background:#000;color:#fff;border-radius:6px;font-size:0.85rem;font-weight:600;text-decoration:none;margin:0 4px">Share on X</a>
    <a href="https://www.linkedin.com/sharing/share-offsite/?url=https://shipsafe.sh" target="_blank" rel="noopener" style="display:inline-block;padding:8px 18px;background:#0a66c2;color:#fff;border-radius:6px;font-size:0.85rem;font-weight:600;text-decoration:none;margin:0 4px">Share on LinkedIn</a>
  </div>

  <div class="footer">
    Generated by <strong>Ship Safe v6.1</strong> — Security toolkit for developers<br>
    <a href="https://shipsafe.sh" style="color:#38bdf8">shipsafe.sh</a> &middot; <a href="https://shipsafe.sh/pricing" style="color:#38bdf8">Cloud Dashboard</a>
  </div>
</div>
</body>
</html>`;
...
<div class="container">
  ...
  <div class="badge-section">
    ...
    <code>[![Ship Safe](https://img.shields.io/badge/Ship_Safe-${scoreResult.grade.letter}-${gradeColors[scoreResult.grade.letter].replace('#','')})](https://shipsafe.sh)</code>
  </div>

  <div class="footer">
    Generated by <strong>Ship Safe v6.1</strong> — Full Security Audit<br>
    <a href="https://shipsafe.sh">shipsafe.sh</a> &middot; <a href="https://shipsafe.sh/pricing">Cloud Dashboard</a>
  </div>
</div>
