...
program
  ...
  .option('--stateful', 'Keep Kimi K3 conversation context between scans for incremental analysis (requires MOONSHOT_API_KEY or KIMI_API_KEY)')
  .option('--model <model>', 'LLM model for stateful watch (default: kimi-k3)')
